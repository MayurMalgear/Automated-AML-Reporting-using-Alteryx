...
## 3. Workflow Overview
![Screenshot - AML Workflow](https://github.com/user-attachments/assets/50627a95-88ca-4191-8937-54aab9e43556)

## 4. Features Implemented

### 4.1. Data Integration & Preparation
...
### 4.2. AML Scenarios & Risk Indicators
...
### 4.3. Advanced Analytics Proxies
...
### 4.4. Comprehensive Risk Scoring & Categorization
...
## 7. Workflow Notes and Assumptions
...
### 8.3. Configuring Reports (Manual Steps in Alteryx Designer)
